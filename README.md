...
> [!NOTE]
> 欢迎加入我们的社区：
> [AI交流群|OneClip](https://qm.qq.com/q/xiImGHVMcM) | [TG 群组](https://t.me/+I7S6R0pw5180YzRl)  

> [!TIP]
> 🌟 OneClip早期代码已开源在 [src/](https://github.com/One-Clip/OneClip/tree/main/src) 目录，可自行下载构建。我**完整开源**了剪贴板核心机制，希望同行竞品仅将其作为技术参考，UI 与产品交互体验自行打磨。

<div align="center">
  <img src="https://i.imgant.com/v2/Az8R0oI.png" alt="OneClip Logo" width="120" height="120">
  <h1>OneClip</h1>
  <p><strong>干净美观的 macOS 剪贴板管理工具</strong></p>
  <p><strong>极速</strong> · <strong>轻量</strong> · <strong>隐私</strong> · <strong>智能</strong></p>
</div>
...
<div align="center">
  <p><strong>OneClip —— 干净美观的 macOS 剪贴板管理工具</strong></p>
