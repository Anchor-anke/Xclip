...
"$REPO_DIR/scripts/test-memory-storage.sh"
"$REPO_DIR/scripts/test-install-local.sh"
"$REPO_DIR/scripts/test-overwrite-installer.sh"
"$REPO_DIR/scripts/test-drag-cancellation.sh"
...
"$REPO_DIR/scripts/test-capture-startup.sh"
