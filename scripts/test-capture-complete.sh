...
CAPTURE=(src/OneClip/CaptureTools.swift src/OneClip/ImageEditorView.swift src/OneClip/CaptureAnnotation.swift
...
"${SWIFT[@]}" "${CAPTURE[@]}" src/OneClip/PinnedImageController.swift tests/PinnedImageTests.swift -o .build/tests/pinned-image-tests
